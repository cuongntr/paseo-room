...
/** Resolve a command to an absolute, executable, canonical path. */
export async function which(command: string, env: NodeJS.ProcessEnv = process.env): Promise<string | undefined> {
