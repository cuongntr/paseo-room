...
- **Does NOT own:** Paseo plugin API stability; Paseo core provider implementation; vendor base prompts; operator-authored global prompts; vendor authentication; OS-level sandboxing; project-specific `docs/WORKSPACE_PROTOCOL.md`; changes to the underlying Supervisor/Lead/Peer authority model.
