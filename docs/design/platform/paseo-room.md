...
| Platform | Linux CI for core lifecycle; macOS test from a minimal GUI-like environment verifies Node-script/native launch prefixes, local Desktop/daemon discovery, spaces in paths, and provider startup. |
